# goose [![Goose CI](https://github.com/SergeiSkv/goose/v3/actions/workflows/ci.yml/badge.svg)](https://github.com/SergeiSkv/goose/v3/actions/workflows/ci.yml) [![Go Reference](https://pkg.go.dev/badge/github.com/SergeiSkv/goose/v3/v3.svg)](https://pkg.go.dev/github.com/SergeiSkv/goose/v3/v3)
...
Starting with [v3.0.0](https://github.com/SergeiSkv/goose/v3/releases/tag/v3.0.0) this project adds Go module support, but maintains backwards compatibility with older `v2.x.y` tags.

Goose supports [embedding SQL migrations](#embedded-sql-migrations), which means you'll need go1.16 and up. If using go1.15 or lower, then pin [v3.0.1](https://github.com/SergeiSkv/goose/v3/releases/tag/v3.0.1).

### Goals of this fork

`github.com/SergeiSkv/goose/v3` is a fork of `bitbucket.org/liamstask/goose` with the following changes:
- No config files
...
# Install
    ...
    $ go install github.com/SergeiSkv/goose/v3/cmd/goose@latest
...
# Hybrid Versioning
Please, read the [versioning problem](https://github.com/SergeiSkv/goose/v3/issues/63#issuecomment-428681694) first.
