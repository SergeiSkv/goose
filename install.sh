...
if [ $# -eq 0 ]; then
	goose_uri="https://github.com/SergeiSkv/goose/v3/releases/latest/download/goose_${os}_${arch}"
else
	goose_uri="https://github.com/SergeiSkv/goose/v3/releases/download/${1}/goose_${os}_${arch}"
fi
