...
func up001(tx pgx.Tx) error { return nil }

func down001(tx pgx.Tx) error { return nil }`
...
func down002(tx pgx.Tx) error { return nil }`
...
func up003(tx pgx.Tx) error { return nil }`
...
func up001(db*pgx.Conn) error { return nil }

func down001(db*pgx.Conn) error { return nil }`
...
func down002(db*pgx.Conn) error { return nil }`
...
func up003(db*pgx.Conn) error { return nil }`
